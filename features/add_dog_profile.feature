...
Background: user has been added to the database and logged in
  ...
  And the following dogs exist:
    | owner_email           | name     | mix              | age | size   | status             | gender | healthy_notes | fixed | description                     | likes                      | dislikes                    | energy_level   | location      |  pics       |
    | student1@berkeley.edu | Princess | labrador         | 4   | medium | I'm a bonehead     | female | none          |  yes  | Healthy and well-behaved dog.   | bones                      | staying inside for too long | high energy    | 1234 Berkeley |  doggy1.png |
    | student2@berkeley.edu | Spock    | Corgi            | 3   | medium | Treat, Don't Trick | male   | none          |  no   | Goofy, energetic, and fearless. | adventure and the outdoors | thunder storms              | sleeps all day | 5312 Berkeley |  doggy2.png |
...
Scenario: create dog profile
  ...
  And I check "Healthy notes" as "none"
